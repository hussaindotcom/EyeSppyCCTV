...
border = tk.Frame(window, bd = 6, bg = "black")
border.pack(pady = 10)
...
label_title = tk.Label(frame1,bg='black',text="Smart cctv Camera")
label_font = font.Font(size=10, weight='bold',family='Helvetica')
label_title['font'] = label_font
label_title.grid(pady=(1,1), column=2)


icon = Image.open('logo.png')
icon = icon.resize((320,250), Image.ANTIALIAS)
...
btn2_image = Image.open('icons/mask.png')
...
btn3_image = Image.open('icons/social.png')
...
btn7_image = Image.open('icons/identify.png')
...
btn1 = tk.Button(frame1, text='Monitor', height=90, width=220, fg='black',command = noise, image=btn1_image, compound='left')
btn1['font'] = btn_font
btn1.grid(row=3, pady=(20,10))

btn2 = tk.Button(frame1, text='Mask\nDetection', height=90, width=220, fg='black', compound='left', image=btn2_image)
btn2['font'] = btn_font
btn2.grid(row=3, pady=(20,10), column=3, padx=(20,5))

btn_font = font.Font(size=25)
btn3 = tk.Button(frame1, text='Social\n Distancing', height=90, width=220, command=main, fg='black',  image=btn3_image, compound='left')
btn3['font'] = btn_font
btn3.grid(row=5, pady=(20,10))

btn4 = tk.Button(frame1, text=' Record', height=90, width=220, fg='black', command=record, image=btn4_image, compound='left')
btn4['font'] = btn_font
btn4.grid(row=5, pady=(20,10), column=3)


btn6 = tk.Button(frame1, text='In Out', height=90, width=220, fg='black', command=in_out, image=btn6_image, compound='left')
btn6['font'] = btn_font
btn6.grid(row=5, pady=(20,10), column=2)

btn5 = tk.Button(frame1, text=" Exit",height=90, width=220, fg='red',compound='left', command=window.quit, image=btn5_image)
btn5['font'] = btn_font
btn5.grid(row=6, pady=(20,10), column=2)

btn7 = tk.Button(frame1, text="identify", fg="black",command=maincall, compound='left', image=btn7_image, height=90, width=220)
btn7['font'] = btn_font
